    ...
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-6">
        <div className="flex items-center justify-center rounded-[10px] bg-gray-3 max-w-[90px] w-full h-22.5">
          ...
          {/* <span className="flex items-center justify-center font-medium text-2xs absolute 
          right-0 top-0 bg-blue w-4.5 h-4.5 rounded-full text-white">
                      {item.quantity}
                    </span> */}
        </div>
        ...
        <div>
          ...
          <div className="inline-block mr-5 mt-3"
          ...
          >
            <div className="w-max flex items-center rounded-md border border-gray-3">
              ...
              <span className="flex items-center justify-center w-9 h-9 border-x border-gray-4">
                {item.quantity}
              </span>
        ...
        <span className="text-custom-sm">Price: {config.CURRENCY_SYMBOL}{item.discountedPrice}</span>
        </div>
