  ...
  return (
    <div className="group">
      ...
      <div className="flex items-center gap-2.5 mb-2">
        ...
        <p className="text-custom-sm">({item.review})</p>
      </div>
      ...
      <span className="flex items-center gap-2 font-medium text-lg mb-1.5">
        <span className="text-dark">${item.price}</span>
        <span className="text-dark-4 line-through">${item.mrp}</span>
      </span>

      {/* sizes */}
      <div className="flex flex-wrap items-center gap-5 mb-1.5">
        <p>Sizes :</p>

        <ul className="flex flex-wrap items-center gap-1">
          {item.size.map(
            (size, key) =>
              <Size key={key} size={size} />
          )}
        </ul>
      </div>
