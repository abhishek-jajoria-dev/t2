...
import SingleListItemOld from "../Shop/SingleListItemOld";
...
const ShopWithSidebar = ({ products }: ProductsPageProps) => {
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="xl:max-w-[870px] w-full">
              ...
              <span className="hidden bg-red bg-red-dark hover:bg-red-dark hover:border-red-dark"></span>
              <span className="hidden bg-yellow bg-yellow-dark hover:bg-yellow-dark hover:border-yellow-dark"></span>
              <span className="hidden bg-blue bg-blue-dark hover:bg-blue-dark hover:border-blue-dark"></span>
              <span className="hidden bg-green bg-green-dark hover:bg-green-dark hover:border-green-dark"></span>
              ...
              >
                {/* {shopData.map((item, key) =>
                  <SingleListItemOld item={item} key={key} />
                )} */}
                {Object.keys(products).map((item, key) =>
                  productStyle === "grid" ? (
                    <SingleGridItem item={products[item]} key={key} />
                  ) : (
                    <SingleListItem item={products[item]} key={key} />
                  )
                )}
              </div>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  try {
    // Define your API endpoint or database fetch logic
    ...
    return {
      props: {
        products: data.products, // Adjust based on your API response structure
        // productStyle: "grid", // Default style for the product display
      },
    };
  } catch (error) {
